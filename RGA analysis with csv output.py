...
a_file = open(r"file.csv", "w")

count = genes.count('RLK')
print("RLK",count, file=a_file)
count = genes.count('TNL')
print("TNL",count, file=a_file)
count = genes.count('RN')
print("RN",count, file=a_file)
count = genes.count('RLP')
print("RLP",count, file=a_file)
count = genes.count('TX')
print("TX",count, file=a_file)
count = genes.count('NL')
print("NL",count, file=a_file)
count = genes.count('NBS')
print("NBS",count, file=a_file)
count = genes.count('CN')
print("CN",count, file=a_file)
count = genes.count('CNL')
print("CNL",count, file=a_file)
count = genes.count('TN')
print("TN",count, file=a_file)
count = genes.count('OTHER')
print("OTHER",count, file=a_file)
count = genes.count('RNL')
print("RNL",count, file=a_file)
